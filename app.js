...
mongoose.connect('mongodb+srv://Campus_Organiser:Nipun-123@cluster0.mlfv5.mongodb.net/Campus_Organiserd?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify:false, useCreateIndex: true});
...
app.post('/register', (req, res) => {
    const newUser = new User({username: req.body.username, name: req.body.name, role: req.body.role});
